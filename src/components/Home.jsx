    ...
    return(
        <div className="home-container"  id="home">
            ...
            <div className="home-container-text">
                ...
                <p>I created several web projects using JavaScript and worked with vanilla Javascript and React JS. I'm in continuous learning about the lastest web technologies and, my goal is to grow as a developer and create apps with an amazing UI.</p>
            </div>
